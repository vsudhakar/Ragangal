...
<html>
  <head>
	...
	<script>
		// File Array
		var files = ['abheri_balamuralikrishna.mp3', 'carukesi_tvs.mp3', 'kamboji_tvs.mp3', 'shankarabaranam_tvs.mp3', 'karaharapriya_sudhar.mp3'];   
	</script>
	...
	<script>
		//Dismiss those pesky success alerts
	...
	<script>
		// Ragams list
		var raagams = ['abogi', 'arabhi', 'abheri','bhairavi', 'carukesi' , 'mohanam', 'saveri', 'thodi', 'kamboji', 'shankarabaranam', 'karaharapriya'];   
...
<body>
	...
	<div class="alert fade in" id = "welcome_alert">
		...
		<strong>Alert!</strong> Welcome to Ragangal, please login to check and save your stats this session.
	</div>
		...
		<div class = "row-fluid">
				...
				<div class = "well">
					...
					<table class = "table">
						<tr>
							...
							<script>
								window.setInterval(function(){$('#msg').html(global_score);},100); 
							</script> 
						</tr>
					</table>
				</div>
			...
			<div class = "span9">
				...
				<div class = "well">
					...
					<button class = "btn btn-inverse" onclick = "stopPlayback()"> Pause </button>
					...
					<div id = "welcomeText" class = "collapse in">
						<div class = "well">
							<p class = "lead">
								Welcome to Ragangal, to begin please press start. Stats are located on the left and sign in is required to 
								view them. Press the pause button to temporarily freeze the game. Help is located in the main menu.
							</p>
						</div>
					</div>
					...
					<div id = "inputFields" class = "collapse down">
						...
						<script type="text/javascript">
							...
							$("#Get").click(function () {
								...
								if(user_answer == global_answer) //Correct
								{
									 $('#success').show();
									 global_score++;
									 getFile();
